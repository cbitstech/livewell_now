...
angular.module('livewellApp')
    .controller('DailyCheckInCtrl', function($scope, $location, $routeParams, Pound, Guid) {
        ...
        $scope.saveCheckIn = function() {
            ...
            var allAnswersFinished = $scope.dailyCheckIn.gotUp != '' & $scope.dailyCheckIn.toBed != '' & $scope.dailyCheckIn.medications != '' & $scope.dailyCheckIn.wellness != '' & $scope.dailyCheckIn.sleepDuration != '';
