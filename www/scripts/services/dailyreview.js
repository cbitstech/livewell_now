        ...
        conditions[20] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen){
                if (sum == 3){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:20}).execute();
                }
                if (sum == 4){
                    Pound.add('clinical_reachout',{call:'coach', message:'Call your psychiatrist about sleeping too much', email:'psychiatrist', code:20});        
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:20}).execute();
                }
            }
        ...
        conditions[19] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen){
                if (sum == 2){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:19}).execute();
                }
                if (sum == 3){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:19}).execute();
                }
            }
        ...
        conditions[18] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen){
                if (sum == 3){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'psychiatrist', code:18}).execute();
                }
                if (sum == 4){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:18}).execute();
                }
            }
            return dailyReviewIsTrueWhen
        };
        conditions[17] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen){
                ...
                if (sum == 3){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:17}).execute();
                }
                if (sum == 4){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:17}).execute();
                }
            }
        ...
        conditions[16] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen){
                ...
                if (sum == 2){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:16}).execute();
                }
                if (sum >= 3){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:16}).execute();
                }
        ...
        conditions[9] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen && code == 1){
                ...
                if (sum == 3){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:9}).execute();
                }
                if (sum == 4){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:9}).execute();
                }
            }
        ...
        conditions[8] = function(data, code) {
            ...
            if (dailyReviewIsTrueWhen && code == 1){
                ...
                if (sum == 2){
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', code:8}).execute();
                }
                if (sum >= 3){                    
                    ...
                    (new PurpleRobot()).emitReading('livewell_clinicalreachout',{call:'coach', email:'psychiatrist', code:8}).execute();
                }
